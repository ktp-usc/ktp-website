        ...
        <div className="main-footer flex flex-col pt-12 pb-4">
          <div className="flex flex-col md:flex-row justify-center items-center gap-12">
            <div className="flex flex-col items-center text-center min-w-[170px] mx-0 font-inter">
              ...
              <p className="mb-4">
                <a
                  href="ocoulam@email.sc.edu"
                  className="hover-text-custom font-medium"
                >
                  ocoulam@email.sc.edu
                </a>
              </p>

              <div className="flex flex-row w-[150px] justify-between">
                <a
                  href="https://groupme.com/join_group/109326258/DG1lHBPm"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="transition-colors duration-200 text-white hover-text-custom"
                >
                  <svg
                    width="40"
                    height="40"
