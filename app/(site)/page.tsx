...
import TypeTwoLines from "@/components/TypeTwoLines";
import { projectData } from "@/data/projects";
import { networkCompanies } from "@/data/networkCompanies";
    ...
    return (
        <div className="font-sans min-h-screen flex flex-col overflow-x-clip">
            <main className="flex flex-col items-center grow pt-4 px-8 pb-0">
                {/* Background blobs */ }
                <div
                    className="flex flex-row justify-center xl:justify-between mb-0 px-6 sm:px-8 md:px-12 lg:px-20 pointer-events-none">
                ...
                <div className="flex flex-col items-center w-full">
                    <section className="px-6 sm:px-8 md:px-16 lg:px-24 xl:px-32 pt-6 pb-8 sm:pt-8 md:pt-10 w-full">
                        <div className="relative w-full overflow-visible">
                            <div
                                className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                                {/* Header + subtitle + Rush button */ }
                                <div
                                    className="lg:col-span-6 lg:order-first order-last flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
                                ...
                                <div className="lg:col-span-6 order-first lg:order-last">
                                    <div className="relative w-full overflow-visible flex justify-center">
                                        <div className="collage-scale relative w-140 h-105 md:w-180 md:h-120">
                                            {/* Top-left */ }
                                            <div
                                            ...
                                            >
                                                <div className="relative w-full h-full">
                                                    <Image src="/Images/collagephoto1.JPG" alt="KTP Symposium" fill
                                            ...
                                            >
                                                <div className="relative w-full h-full">
                                                    <Image src="/Images/collagephoto2.JPEG" alt="KTP pumpkin carving"
                                            ...
                                            >
                                                <div className="relative w-full h-full">
                                                    <Image src="/Images/collagephoto3.JPG" alt="KTP Alpha class" fill
                                                           style={ { objectFit: "cover" } }/>
                                                </div>
                                            </div>
                                            ...
                                            >
                                                <div className="relative w-full h-full">
                                                    <Image src="/Images/collagephoto4.JPG" alt="KTP speaker" fill
                                                           style={ { objectFit: "cover" } }/>
                                                </div>
                                            </div>
                        ...
                        <section className="w-full py-45">
                            <div className="relative max-w-6xl mx-auto bg-gray-50 rounded-2xl overflow-hidden">
                                <div
                                    className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-12 px-6 sm:px-8 md:px-12 lg:px-16 py-12">
                                    {/* heading on left */ }
                                    <div className="lg:col-span-7 xl:col-span-6">
                                        <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 leading-tight text-center">About
                                            KTP</h2>
                                    ...
                                    <div
                                        className="lg:col-span-5 xl:col-span-6 flex justify-center lg:justify-end relative">
                                        ...
                                        >
                                            <Image src="/Images/alphaclass.jpeg" alt="KTP Alpha class" width={ 900 }
                                                   height={ 600 } className="object-cover w-full h-full block"
                                                   priority={ false }/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <section className="px-6 sm:px-8 md:px-16 lg:px-24 xl:px-32 py-8 sm:py-12 md:py-16">
                                    <div
                                        ...
                                        <div className="w-full lg:w-3/5 text-left relative z-10">
                                            <h2 className="text-center text-2xl sm:text-4xl font-black mb-10">President&apos;s
                                                Welcome</h2>
                                            <div className="text-base sm:text-lg leading-relaxed space-y-4">
                                                <p>Welcome to the Alpha Theta Chapter of Kappa Theta Pi, a co-ed
                                                    professional technology fraternity
                                                    at the University of South Carolina. On behalf of our chapter, I
                                                    welcome you to our website,
                                                    where you can learn about the work we do and the values we strive to
                                                    embody. I believe that
                                                    we offer our members unmatched professional and technical
                                                    development opportunities that build
                                                    skills applicable in the workplace and beyond.</p>

                                                <p>Our chapter is set apart by being the first nationally to pioneer an
                                                    innovative nonprofit
                                                    consulting initiative. Each semester, we take on 3-4 nonprofit
                                                    clients, and assign a student
                                                    team to work on a project to help further their goals. This creates
                                                    a win-win arrangement:
                                                    nonprofits get pro bono support that helps them focus resources on
                                                    their core mission, while
                                                    students get real-world technology project experience using
                                                    industry-standard tools.</p>

                                                <p>From being a founding member to becoming its president, I’ve been
                                                    honored to be a part of this
                                                    organization. Beyond the professional work, I’ve had so much fun
                                                    getting to know the incredible
                                                    community that makes every event something to look forward to. We
                                                    welcome new members from all
                                                    majors and all backgrounds, brought together by our shared
                                                    commitment to personal and professional
                                                    growth. Whether you’re a student looking for opportunities while in
                                                    college or a nonprofit
                                ...
                                <section className="w-full py-16">
                                    <div className="relative max-w-6xl mx-auto bg-gray-50 rounded-2xl overflow-hidden">
                                        <div
                                            ...
                                            {/* image on left */ }
                                            <div
                                                className="lg:col-span-5 xl:col-span-6 flex justify-center lg:justify-start relative order-first lg:order-first">
                                                {/* green blob behind image */ }
                                                <div
                                                    className="absolute -top-20 -left-20 z-0 blob-c pointer-events-none">
                                                    <div className="shape-blob eight absolute"/>
                                                    <div className="shape-blob nine absolute"/>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <Image src="/Images/history-photo.JPG" alt="KTP Alpha Class"
                                            ...
                                            <CarouselItem key={ p.id } className="w-full">
                                                <div className="flex flex-col md:flex-row items-start">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            className="relative w-full h-full overflow-hidden rounded-xl transform transition-transform duration-300 hover:-translate-y-3">
                                                            <AspectRatio ratio={ 5 / 4 }>
                                                                <Image src={ p.image } alt={ `${ p.title } logo` } fill
                        ...
                        <div className="px-6 sm:px-8 md:px-12 lg:px-20">
                            <div
                                className="flex justify-center text-3xl lg:text-4xl font-semibold mt-10 mb-12 font-inter"
                                style={ { fontWeight: 680, letterSpacing: "-0.02em" } }>
                                Our Network
                            </div>
                            <div
                                className="flex flex-wrap justify-center items-center pb-10 gap-4 lg:gap-8 mb-8 min-h-40 lg:min-h-45">
