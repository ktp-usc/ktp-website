...
export default function HomePage() {
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-800 transition-colors duration-300">
            <ThemeToggle/>
            {/* Header */ }
            <header
            ...
            <main className="max-w-7xl mx-auto px-6 py-8 bg-white-100 bg-transparent transition-colors duration-300">
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <span
                                                className={ `px-3 py-1 rounded-full text-xs font-medium border ${ getStatusColor(user.application.status) }` }>
                ...
                { user.role === "exec" && (
                    <div className="space-y-6">
                        <h3 className="text-xl font-semibold text-gray-900 dark:text-white transition-colors duration-300">Executive
                            Dashboard</h3>
