...
function formFromSources(app: any | null, account: any | null): FormState {
  ...
  return {
    ...
    // application
    preferredFirstName:
      normalizeString(app?.preferredFirstName) ||
      normalizeString(app?.preferred_first_name),
    ...
    // read-only from db
    rushEvents: Array.isArray(app?.eventsAttended)
      ? (app.eventsAttended as string[])
      : [],
...
export default function PortalApplicationPage() {
  ...
  const loading =
    session.isFetching || accountQuery.isFetching || applicationLoading;
  const isPastDeadline = Date.now() > APPLICATION_DEADLINE_ET.getTime();

  // local form state
  const [form, setForm] = useState<FormState>(() =>
    formFromSources(null, null),
  );
  ...
  async function submitApplication() {
    ...
    if (!form.circumstance.trim() && numericGPA < 3.0) {
      toast.error(
        "Please complete the Extenuating Circumstances section before submitting.",
      );
      return;
    }
    ...
    if (words.length > 150) {
      toast.error(
        `Your "Why KTP" response is ${words.length} words. Please keep it under 150 words.`,
      );
      return;
    }
    ...
    const confirmed = window.confirm(
      "Submit your application now? You will not be able to edit after submitting.",
    );
    if (!confirmed) return;
  ...
  const [headshotPreview, setHeadshotPreview] = React.useState<string | null>(
    null,
  );
  const [headshotOriginalFile, setHeadshotOriginalFile] =
    React.useState<File | null>(null);

  const [headshotCrop, setHeadshotCrop] = React.useState({ x: 0, y: 0 });
  const [headshotZoom, setHeadshotZoom] = React.useState(1);
  const [headshotCroppedAreaPixels, setHeadshotCroppedAreaPixels] =
  ...
  async function handleSaveHeadshotCropAndUpload() {
    try {
      ...
      if (
        !headshotPreview ||
        !headshotCroppedAreaPixels ||
        !headshotOriginalFile
      ) {
      ...
      if (
        headshotCroppedAreaPixels.width !== headshotCroppedAreaPixels.height
      ) {
        toast.error("Headshots must be square. Please adjust your crop.");
        return;
      }

      const croppedFile = new File([croppedBlob], headshotOriginalFile.name, {
        type: "image/jpeg",
      });
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center transition-colors duration-300">
        ...
        <main className="max-w-4xl mx-auto px-6 py-20">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() =>
                  router.push("/auth/sign-up?redirectTo=/portal/application")
                }
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300 mb-6">
          <div className="space-y-3 text-gray-900 dark:text-gray-100">
            <p>
              Thank you for your interest in becoming a member of Kappa Theta
              Pi!
            </p>
            <p>
              Kappa Theta Pi is a Professional Co-Ed Technology Fraternity
              founded in 2012, aiming to develop a talented slate of future
              computing professionals. The Alpha Theta Chapter at the University
              of South Carolina welcomes you to its second recruitment cycle for
              its Beta class.
            </p>
            <p className="text-gray-600 dark:text-gray-400">
              If you have any questions, please reach out to the executive board
              at{" "}
              <a
              ...
              .{" "}
              <em>
                Please note that this application will not save your progress
                unless you click “Save Draft.”
              </em>
            </p>
            <p>
              <strong>
                Incomplete applications will not be accepted. To verify your
                application is complete, check for the status "Under Review" in
                your portal home page once you submit.
              </strong>
            </p>
          </div>
          ...
          <div className="mt-5 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-4">
            <p className="font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
              <svg
                className="w-5 h-5 text-[#315CA9] shrink-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
                Upload an image file with your face, clearly visible. The
                purpose of this is to allow us to put a face to your name.
              </p>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
                PDF format only. If you don’t have a polished resume, a simple
                bullet list of jobs, involvement, and projects is okay.
              </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                Please ensure this is correct. Interview communications will be
                sent via email.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300 mb-6">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            These fields save to your{" "}
            <span className="font-medium">Account</span> and will show across
            the portal.
          </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            These fields save to your{" "}
            <span className="font-medium">Application</span> draft.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                KTP expects a minimum 3.00 GPA; anyone interested is welcome to
                apply.
              </p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                If your GPA is below a 3.00, explain any extenuating
                circumstances or hardships you’d like us to consider.
              </p>
              <textarea
                id="circumstance"
                name="circumstance"
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
                This section is <span className="font-medium">read-only</span>.
                It shows the rush events currently recorded on your application.
              </p>
              ...
              {form.rushEvents.length > 0 ? (
                ...
                <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-4">
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    No rush events have been recorded yet.
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    If you haven’t attended an event yet, check the Rush page
                    for the schedule and make sure you get checked in.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                I affirm this application is complete and correct to the best of
                my knowledge. <span className="text-red-500">*</span>
              </label>
              <div
                className={`flex items-center gap-3 ${!canEdit ? "opacity-60" : ""}`}
              >
                <input
                  id="affirmation"
                  type="checkbox"
          ...
          <div className="mt-5 text-xs text-gray-500 dark:text-gray-400">
            Tip: Click <span className="font-medium">Save Draft</span>{" "}
            frequently. Submitting locks your application.
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300 mt-6">
          <div className="flex gap-3">
            <Button
              ...
              disabled={
                !canEdit ||
                saving ||
                createMyApp.isPending ||
                updateMyApp.isPending ||
          ...
          {!application && !isSubmitted ? (
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">
              You haven’t saved an application yet. Fill out the form and click{" "}
              <span className="font-medium">Save Draft</span> to create it.
            </p>
          ) : null}
