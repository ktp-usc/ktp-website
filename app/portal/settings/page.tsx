...
export default function SettingsPage() {
  ...
  const handleDeleteMajor = (majorToDelete: string) => {
    setUser((prev) => ({
      ...prev,
      majors: prev.majors.filter((major) => major !== majorToDelete),
    }));
  };
  const handleDeleteMinor = (minorToDelete: string) => {
    setUser((prev) => ({
      ...prev,
      minors: prev.minors.filter((minor) => minor !== minorToDelete),
    }));
  };

  const handleHeadshotChange = async (
        ...
        <main className="max-w-4xl mx-auto px-6 py-20">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() =>
                  router.push("/auth/sign-up?redirectTo=/portal/settings")
                }
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
            ...
            <div className="flex items-center gap-6">
              {headshotUrl ? (
                ...
                <div className="h-25 w-25 rounded-full border-4 border-blue-200 dark:border-blue-700 bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex justify-between w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2 text-gray-900 dark:text-white bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors">
                  <input
                    type="text"
                    id="Major"
                    name="Major"
              ...
              <div className="flex flex-col gap-4">
                {user.majors.map((major) => (
                  <div
                    key={major}
                    className="flex justify-between w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2 text-gray-900 dark:text-white bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                  >
                    <p>{major}</p>
                    <button
                      className="cursor-pointer"
