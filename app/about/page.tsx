...
import Image from "next/image";   // change to `{ Header }` if it's a named export
import screenshot_owen from "@/public/Images/Screenshot Owen.png";
import group_photo from "@/public/Images/group-photo.png";
