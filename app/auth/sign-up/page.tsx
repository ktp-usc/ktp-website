...
export default function SignUpPage() {
    ...
    const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        if (signUpsClosed) {
            ...
            setErrorMessage("Public account creation is disabled at the moment. Please check back later or contact the executive board if you believe this is an error.");
            return;
        }
    ...
    const blockForm = signUpsClosed || session.isLoading || Boolean(session.data?.user);
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 lg:px-16">
                    <div className="space-y-6">
                        <div className="inline-block">
                            <Image src="/KTPLettersW.svg" alt="Kappa Theta Pi logo" width={ 220 } height={ 140 }
                                   priority/>
            ...
            <div
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="flex justify-center mb-6">
                        <Image src="/KTPLettersW.svg" alt="Kappa Theta Pi logo" className="hidden dark:block"
                               width={ 120 } height={ 40 }/>
                        <Image src="/KTPLetters.svg" alt="Kappa Theta Pi logo" className="block dark:hidden"
                               width={ 120 } height={ 40 }/>
                    </div>
                    ...
                    <div
                        ...
                        { signUpsClosed ? (
                            <>
                                <h2 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">Sign Ups Are
                                    Currently Closed</h2>
                                <p className="text-gray-600 dark:text-gray-400 mb-6">
                                    Public account creation is disabled at the moment. Please check back later or
                                    contact the executive board if you believe this is an error.
                                </p>
                            ...
                            <>
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mb-5">Create your account to get
                                    started</p>

                                { session.isLoading ? (
                                    <div
                                        className="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-4 py-3 text-sm text-gray-700 dark:text-gray-300">
                                ...
                                <form className="space-y-5" action={ formAction } onSubmit={ handleSubmit }>
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                            Please ensure password is 8 characters long, contains at least one uppercase
