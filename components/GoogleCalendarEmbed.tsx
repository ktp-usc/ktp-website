...
// Shared chapter calendar embed, used on both the public /calendar page and
// the member portal's /portal/calendar page so the two never drift apart.
export default function GoogleCalendarEmbed() {
    return (
        <div className="w-full bg-white rounded-xl shadow-md p-6 sm:p-8 dark:bg-gray-900 dark:border dark:border-gray-700 transition-colors duration-300">
            {/* Embed */}
